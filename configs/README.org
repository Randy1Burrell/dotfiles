...
- [[#terminal][Terminal]]
  ...
  - [[#zsh][ZSH]]
    - [[#zsh-folders][ZSH Folders]]
      ...
      - [[#power10k][Power10k]]
- [[#vim][Vim]]
  - [[#vim-local-plugins][Vim Local Plugins]]
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/custom/init-treesitter-customizations.el :mkdirp yes
  ;;; init-treesitter-customizations.el --- Completion with Corfu -*- lexical-binding: t -*-
  ;;; Commentary:
  ;;; Code:
...
**** Env locals
    ...
    #+begin_src shell :noweb-ref Paths :noweb no-export
      export PATH=<<Personal Paths>>:<<Languages Paths>>:<<Homebrew Paths>>:<<Nix Paths>>:<<Android Paths>>:<<Binary Paths>>:$PATH
    #+end_src
...
** COMMENT Neo Vim Config
  ...
  #+begin_src vimrc :notangle ~/.config/nvim/init.vim :mkdirp yes
    " Installing this package instead  https://github.com/NvChad/NvChad?tab=readme-ov-file
    set runtimepath^=/.vim runtimepath+=~/.vim/after
    set runtimepath+=~/.vim-plugins/LanguageClient-neovim

    let &packpath = &runtimepath
    let g:python3_host_prog = '/usr/bin/python3'
    " Disable perl, node and ruby providers
  ...
  #+begin_src vimrc :tangle ~/.config/nvim/init.lua :mkdirp yes
...
** Vim Local Plugins
#+begin_src vimrc :tangle ~/.vim/plugin/BufOnly.vim :mkdirp yes
...
#+begin_src vimrc :tangle ~/.vim/plugin/scratch.vim :mkdirp yes
  " File: scratch.vim

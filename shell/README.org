...
New set up here https://dev.to/devsk1207/how-to-setup-zsh-on-mac-terminal-37dj
...
*** Interactive
  #+begin_src shell :tangle ~/.shell/interactive :mkdirp yes
    ...
    plugins=(git rvm docker docker-compose nix-zsh-completions nvm zsh-autosuggestions zsh-syntax-highlighting web-search pyenv-lazy)

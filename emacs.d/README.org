...
** Editing Utils
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-editing-utils.el
...
** Straight
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-straight.el
  ...
  #+end_src
** Protocol Buffer
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-protobuf.el
...
** Copilot
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-copilot.el
...
** Docker
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-docker.el
...
** Magit
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-magit.el -n
     ...
     ;; Refresh magit buffer when files are changed in the respective repository
...
** Solidity
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-solidity.el
...
** Tramp
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-tramp.el
...
** PDF Viewer
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-pdf.el
...
** Web Development Extras
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-webdev.el
     ...
     ;;------------------------------------------------------------------------------
     (defun rb/prettier ()
       "If certain file extension match then set up prettier."
       (mapc
        (lambda (x)
...
** Shells
   #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-shell.el

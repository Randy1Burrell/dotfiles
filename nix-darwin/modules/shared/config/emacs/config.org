...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "randy1burrell"
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/randyburrell/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/randyburrell/bin" "/profile/bin" "/Users/randyburrell/.npm-packages/bin" "/Users/randyburrell/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC

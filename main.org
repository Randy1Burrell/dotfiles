...
** Org Mode
 ...
 #+begin_src emacs-lisp :tangle ~/.emacs.d/lisp/init-org.el
   ...
   ;; Copied from https://orgmode.org/worg/org-contrib/babel/how-to-use-Org-Babel-for-R.html
   ;; I think this would be better served within a snippet such as Yankpad/YaSnippet.
   (define-skeleton org-skeleton
     ...
     "#+INFOJS_OPT: \n"
     "#+BABEL: :session *Lang* :cache yes :results output graphics :exports both :tangle yes \n"
     "-----")
